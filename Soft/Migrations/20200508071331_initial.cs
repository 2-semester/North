    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SportCategoryId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Events", x => new { x.EventListId, x.OrganizationId, x.TypeId, x.SportCategoryId, x.LocationId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportCategoryTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SportsmanEvents",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportsmanEvents", x => new { x.SportsmanId, x.EventId });
                });
